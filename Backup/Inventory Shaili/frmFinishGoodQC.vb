...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.gdqc.Name = "gdqc"
        Me.gdqc.Size = New System.Drawing.Size(688, 224)
        Me.gdqc.TabIndex = 15
        ...
        Me.grpqc.Name = "grpqc"
        Me.grpqc.Size = New System.Drawing.Size(730, 512)
        Me.grpqc.TabIndex = 0
        '
        'Label4
        '
        ...
        'cmdsave
        '
        Me.cmdsave.Location = New System.Drawing.Point(576, 480)
        ...
        Me.cmdclose.Location = New System.Drawing.Point(648, 480)
        ...
        Me.pnlQCDetail.Size = New System.Drawing.Size(712, 368)
        ...
        Me.txtBatchNo.Location = New System.Drawing.Point(104, 72)
        ...
        Me.txtinspecno.Location = New System.Drawing.Point(104, 40)
        ...
        Me.lblqcno.Location = New System.Drawing.Point(224, 40)
        ...
        'cmdAdd
        '
        Me.cmdAdd.Location = New System.Drawing.Point(576, 104)
        ...
        'cmdDelete
        '
        Me.cmdDelete.Location = New System.Drawing.Point(640, 104)
...
#End Region
    ...
    Private Sub frmFinishGoodQC_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        FillLookup("select fgname,fid,Draw_no from fgmaster", "FGmaster", "Product Name", "FID", lkupFGName)
    ...
    Private Sub bind_data()
        ...
        Try
            ...
            Dim adp = New OleDb.OleDbDataAdapter("SELECT FinishGoods_QCDetail.FID,FGMaster.FGName as Finish_Good, FinishGoods_QCDetail.Dim_Check as Dimension_Check, FinishGoods_QCDetail.Inspected_No, FinishGoods_QCDetail.QC_No, FinishGoods_QCDetail.Reject_Qty, FinishGoods_QCDetail.Reason, FinishGoods_QCDetail.MIS_NO, FinishGoods_QCDetail.Batch_NO " _
                           & " FROM FinishGoods_QCDetail INNER JOIN FGMaster ON FinishGoods_QCDetail.FID = FGMaster.FID " _
    ...
    Private Sub cmdsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdsave.Click
        Try
            If strcheck = "Add" Then
                cmd = New OleDb.OleDbCommand
                cmd.Connection = conn
                cmd.CommandText = "insert into FinishGoods_QCMaster values ('" & txtSrNo.Text.Trim & "','" & Replace(txtVI_No.Text, "''", "'") & "','" & dtinspection.Text & "'," & chkSCheck.Checked & "," & IIf(dtST_Check.Text = "", "Null", "'" & dtST_Check.Text & "'") & ",'" & strCY.Trim & "')"
            ...
            ElseIf strcheck = "Edit" Then
                ...
                cmd = New OleDb.OleDbCommand
                cmd.CommandText = "Update FinishGoods_QCMaster set VI_Date ='" & dtinspection.Text & "',ST_CHECK =" & chkSCheck.Checked & ", ST_DATE =" & IIf(dtST_Check.Text = "", "Null", "'" & dtST_Check.Text & "'") & " where fgvi_no= '" & txtVI_No.Text & "' and SR_No =" & txtSrNo.Text   '& "' and CY ='" & strCY.Trim & "'"
                cmd.Connection = conn
                cmd.Transaction = conn.BeginTransaction
                cmd.ExecuteNonQuery()
