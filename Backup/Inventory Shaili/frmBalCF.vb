    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        Try
            If txtCY.Text = "" Or dtClosingDate.Text = "" Then
                ...
                Exit Sub
            End If
            If MessageBox.Show("Are you sure you want to process for this operation?", "Balance Carry Forward", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                If MessageBox.Show("Make sure you have read all important point and you want to continue with this process. Do you want to continue with process?", "Continue...", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = Windows.Forms.DialogResult.Yes Then
                    Call BalanceCF()
