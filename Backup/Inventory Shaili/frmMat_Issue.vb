...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.grpMat_Issue.Size = New System.Drawing.Size(512, 336)
        ...
        Me.GroupControl1.Size = New System.Drawing.Size(496, 224)
        ...
        Me.grdMatIssue.Size = New System.Drawing.Size(480, 200)
        ...
        Me.cmdcancel.Location = New System.Drawing.Point(448, 352)
        ...
        'cmdsave
        '
        Me.cmdsave.Location = New System.Drawing.Point(376, 352)
    ...
    Private Sub cmdsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdsave.Click
        ...
        Try
            ...
            ElseIf strcheck = "Edit" Then
                ...
                cmd.Connection = conn
                cmd.Transaction = conn.BeginTransaction
                cmd.CommandText = "update Material_Issue_Master set mis_no = '" & txtMatIssNo.Text.Trim & "', mis_date = '" & dtpMatIssDate.Text & "',vi_check =" & chkVIReq.Checked & " where mis_No = '" & ModMain.strgridid & "'" ' and CY ='" & strCY.Trim & "'"
                cmd.ExecuteNonQuery()
