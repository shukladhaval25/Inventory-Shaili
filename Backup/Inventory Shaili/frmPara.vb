...
#End Region
    ...
    Private Sub frmPara_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Select Case strReport
                ...
                Case "RM_Stock", "RMCompReg", "RMStockCons"
                    SetFormDesign(True)
                    ...
                    'FillLookup("Select RMItemMaster.RMItemName,RMItemMaster.Rid from RMItemMaster ", "RMItem", "Item Name", "Item ID", lkupName)
                    'lkupName.Properties.Columns(1).Visible = True
                    'grpdate.Visible = True
                    'lblName.Text = "Item Name"
                    'filllookup("SELECT RMItemMaster.RMItemName, UnitMaster.UnitName, RMStock.Date, RMStock.RMVI_No, RMStock.Type, RMStock.Received_Qty, RMStock.Issue_Qty, RMStock.RMVI_No " _
                    '    & " FROM (RMItemMaster INNER JOIN RMStock ON RMItemMaster.Rid = RMStock.RID) INNER JOIN UnitMaster ON RMItemMaster.UnitId = UnitMaster.UnitID " _
                    '    & " WHERE (((RMStock.RMVI_No)="RM0393/06"))
                    'DHAVAL
                Case "FCQC_Rpt"
                ...
                Case "MIS"
                    ...
                    'lkupName.Properties.Columns(1).Visible = True
                    'lkupName.Properties.Columns(2).Visible = False
                Case "Sterilization", "PendingRMVI", "PendingMIS", "Purchase_Reg", "Sales_Reg", "Batch_Stock_Reg", "PendingStrz", "DemoSales"
                    lblName.Visible = False
                    lkupName.Visible = False
        ...
        Try
            If lkupName.EditValue <> "" Then
                ...
                If strReport = "BatchReg_Rpt" Or strReport = "RMList" Or strReport = "FGList" Or _
                   ...
                   strReport = "InwardTriplicate" Or strReport = "PWCWS" Or strReport = "CWPWS_Cons" Or strReport = "PWCWS_Cons" Then
    ...
    Private Sub ShowPendingStrz()
        Try
            ...
            strsql = "SELECT FinishGoods_QCMaster.FGVI_NO, format(FinishGoods_QCMaster.VI_Date,'dd/MM/yyyy') as VDATE, FGMaster.FGName, FinishGoods_QCDetail.Batch_NO, FinishGoods_QCDetail.MIS_NO " _
                ...
                & " WHERE (((FinishGoods_QCMaster.VI_Date) Between #" & Format(dtpFrom.EditValue, "MM/dd/yyyy") & "# and #" & Format(dtpTo.EditValue, "MM/dd/yyyy") & "#) AND ((FinishGoods_QCMaster.St_Check)=Yes) AND ((FinishGoods_QCMaster.St_Date) Is Null)); "
    ...
    Public Sub ShowMat_Req(ByVal strReqID As String)
        Try
            ...
            Else
                ...
                Dim strSql As String
                Dim ds As New DataSet
                strSql = "SELECT FGMaster.FGName, REQMASTER.REQID,FORMAT(REQMASTER.REQDATE,'DD/MM/YYYY') AS RDATE, RMItemMaster.RMItemName, REQDETAIL.QTY,  REQMASTER.QTY AS FGQTY " _
                    ...
                    & " GROUP BY FGMaster.FGName, REQMASTER.REQID,REQMASTER.REQDATE, RMItemMaster.RMItemName, REQDETAIL.QTY, REQMASTER.QTY " _
    ...
    Public Sub ShowChallan(ByVal strChallanID As String)
        Try
            If strChallanID Is Nothing Or strChallanID.Trim = "" Then
            ...
            Else
                ...
                Dim strSql As String
                Dim ds As New DataSet
                strSql = "SELECT CustomerMaster.CustName, CustomerMaster.CustADD, CustomerMaster.CustCity, CustomerMaster.CustPin, " _
                    ...
                    & " FORMAT(ChallanMaster.Des_Date,'DD/MM/YYYY') as Des_Date, FGMaster.FGName, ChallanDetail.BatchID, ChallanDetail.Qty, ChallanDetail.Rate, ChallanDetail.Remarks" _
