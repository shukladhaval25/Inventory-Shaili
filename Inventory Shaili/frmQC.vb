        ...
        Try
            ...
            If strcheck = "Add" Then
                ...
                For i = 0 To gvqc.RowCount - 1
                    ...
                    cmd.CommandText = "Insert into RMStock values ('" & gvqc.GetRowCellValue(i, "ItemID") & "','" & _
                         dtinspection.Text & "','" & txtVI_No.Text & "','Inward'," & gvqc.GetRowCellValue(i, "Accepted Qty") & ",0,0," & gvqc.GetRowCellValue(i, "Accepted Qty") & ",'" & strCY.Trim & "')"
                    cmd.ExecuteNonQuery()
                Next
            ...
            ElseIf strcheck = "Edit" Then
                ...
                For i = 0 To gvqc.RowCount - 1
                    ...
                    cmd.CommandText = "Insert into RMStock values ('" & gvqc.GetRowCellValue(i, "ItemID") & "','" & _
                         dtinspection.Text & "','" & txtVI_No.Text & "','Inward'," & gvqc.GetRowCellValue(i, "Accepted Qty") & ",0," & gvqc.GetRowCellValue(i, "Accepted Qty") & ",0,'" & strCY.Trim & "')"
                    cmd.ExecuteNonQuery()
