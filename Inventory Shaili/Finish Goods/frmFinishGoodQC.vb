Public Class frmFinishGoodQC
    ...
    Friend WithEvents lkupPkgVINo As DevExpress.XtraEditors.LookUpEdit
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        CType(Me.dtinspection.Properties.CalendarTimeProperties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.gdqc.Location = New System.Drawing.Point(8, 139)
        Me.gdqc.MainView = Me.gvqc
        Me.gdqc.Name = "gdqc"
        Me.gdqc.Size = New System.Drawing.Size(1087, 221)
        Me.gdqc.TabIndex = 15
        ...
        'dtST_Check
        '
        Me.dtST_Check.EditValue = ""
        Me.dtST_Check.Location = New System.Drawing.Point(920, 54)
        ...
        Me.dtST_Check.Properties.CalendarTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton()})
        Me.dtST_Check.Properties.Mask.EditMask = "dd/MM/yyyy"
        Me.dtST_Check.Properties.NullDate = ""
        ...
        Me.Label3.Location = New System.Drawing.Point(768, 54)
        ...
        'chkSCheck
        '
        Me.chkSCheck.Location = New System.Drawing.Point(496, 54)
        ...
        Me.dtinspection.Location = New System.Drawing.Point(921, 27)
        ...
        Me.dtinspection.Properties.CalendarTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton()})
        ...
        Me.lbldate.Location = New System.Drawing.Point(768, 27)
        ...
        'pnlQCDetail
        '
        Me.pnlQCDetail.Controls.Add(Me.lkupPkgVINo)
        Me.pnlQCDetail.Controls.Add(Me.dtPackingVI)
        ...
        '
        Me.cmbMIS.EditValue = ""
        Me.cmbMIS.Location = New System.Drawing.Point(288, 79)
        ...
        Me.txtBatchNo.Location = New System.Drawing.Point(104, 79)
        ...
        Me.cmbreason.Location = New System.Drawing.Point(568, 79)
        ...
        Me.Label2.Location = New System.Drawing.Point(416, 79)
        ...
        Me.lblLotno.Location = New System.Drawing.Point(8, 79)
        ...
        Me.lblVI.Location = New System.Drawing.Point(361, 28)
        Me.lblVI.Name = "lblVI"
        ...
        Me.txtVI_No.Location = New System.Drawing.Point(499, 25)
        ...
        Me.Name = "frmFinishGoodQC"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Visual Inspection of Final Product"
        ...
        CType(Me.dtinspection.Properties.CalendarTimeProperties, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Private Sub frmFinishGoodQC_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim strSql As String = " Material_Issue_Master LEFT JOIN FinishGoods_QCDetail ON Material_Issue_Master.MIS_NO = FinishGoods_QCDetail.MIS_NO" _
        & " WHERE (((FinishGoods_QCDetail.Inspected_No) Is Null)) OR (((FinishGoods_QCDetail.Inspected_No)<[Material_Issue_Master]![FG_QTY]));"
        ...
        If strcheck = "Add" Then
            ...
            cmd.CommandText = "select max(Sr_No) from FinishGoods_QCMaster where cy ='" & strCY.Trim & "'"
        ...
        If strcheck = "Edit" Then
            cmd = New OleDb.OleDbCommand
            cmd.Connection = conn
            cmd.CommandText = "select * from finishgoods_qcmaster where FGVI_NO = '" & strgridid & "'" ' and CY ='" & strCY.Trim & "'"
    ...
    Private Sub bind_data()
        ...
        Try
            ...
            End If
            If IsDBNull(dr("FGVI_NO")) = True Then
                txtVI_No.Text = ""
            Else
                txtVI_No.Text = dr("FGVI_NO").ToString
            End If
            ...
            Dim adp = New OleDb.OleDbDataAdapter("SELECT FinishGoods_QCDetail.FID,FGMaster.FGName as Finish_Good, FinishGoods_QCDetail.Dim_Check as Dimension_Check, FinishGoods_QCDetail.Inspected_No, FinishGoods_QCDetail.QC_No, FinishGoods_QCDetail.Reject_Qty, FinishGoods_QCDetail.Reason, FinishGoods_QCDetail.MIS_NO, FinishGoods_QCDetail.Batch_NO " _
                          & " ,FinishGoods_QCDetail.MFG_Date, FinishGoods_QCDetail.Exp_Date FROM FinishGoods_QCDetail INNER JOIN FGMaster ON FinishGoods_QCDetail.FID = FGMaster.FID " _
                          & " WHERE (((FinishGoods_QCDetail.FGVI_NO)='" & strgridid & "'))", conn) 'and FinishGoods_QCDetail.CY ='" & strCY.Trim & "'
            adp.fill(dt)
            gdqc.DataSource = dt
    ...
    Private Sub cmdAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAdd.Click
        Try
            ...
            If blnDup = False Then
                cmd = New OleDb.OleDbCommand
                cmd.Connection = conn
                cmd.CommandText = "SELECT Count(FinishGoods_QCDetail.Batch_NO) AS CountOfBatch_NO, FinishGoods_QCDetail.FID, FinishGoods_QCDetail.Batch_NO " _
                    & " FROM FinishGoods_QCMaster INNER JOIN FinishGoods_QCDetail ON FinishGoods_QCMaster.FGVI_NO = FinishGoods_QCDetail.FGVI_NO " _
                    & " GROUP BY FinishGoods_QCDetail.FID, FinishGoods_QCDetail.Batch_NO " _
                    & " HAVING (((FinishGoods_QCDetail.FID)='" & lkupFGName.Tag & "') AND ((FinishGoods_QCDetail.Batch_NO)='" & txtBatchNo.Text & "'))"
                If cmd.ExecuteScalar = 0 Then
                    ...
                    dr.Item(9) = dtMfgDate.DateTime
                    dr.Item(10) = dtExpDate.DateTime
                    dt.Rows.Add(dr)
                    gdqc.DataSource = dt
                    gvqc.Columns("FID").Visible = False
                End If
    ...
    Private Sub cmdsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdsave.Click
        Try
            If strcheck = "Add" Then
                ...
                For i As Int16 = 0 To gvqc.RowCount - 1
                    'Finish Good QC
                    cmd.CommandText = "insert into FinishGoods_QCDetail values('" & txtVI_No.Text & "','" & gvqc.GetRowCellValue(i, "FID") & "','" & gvqc.GetRowCellValue(i, "Dimension_check") & "'," & gvqc.GetRowCellValue(i, "Inspected_No") & "," & gvqc.GetRowCellValue(i, "QC_No") & "," & gvqc.GetRowCellValue(i, "Reject_Qty") & ",'" & gvqc.GetRowCellValue(i, "Reason") & "','" & gvqc.GetRowCellValue(i, "MIS_NO") & "','" & gvqc.GetRowCellValue(i, "Batch_NO") & "','" & strCY.Trim &
            ...
            ElseIf strcheck = "Edit" Then
                ...
                cmd = New OleDb.OleDbCommand
                cmd.CommandText = "Update FinishGoods_QCMaster set PKG_VI_NO ='" & txtPackingVINo.Text & "',PKG_VI_DATE='" & dtPackingVI.Text & "', VI_Date ='" & dtinspection.Text & "',ST_CHECK =" & chkSCheck.Checked & ", ST_DATE =" & IIf(dtST_Check.Text = "", "Null", "'" & dtST_Check.Text & "'") & " where fgvi_no= '" & txtVI_No.Text & "' and SR_No =" & txtSrNo.Text   '& "' and CY ='" & strCY.Trim & "'"
                cmd.Connection = conn
                cmd.Transaction = conn.BeginTransaction
                cmd.ExecuteNonQuery()
                cmd.CommandText = "delete from FinishGoods_QCDetail where fgvi_no = '" & txtVI_No.Text & "'" ' and CY ='" & strCY.Trim & "'"
                cmd.Connection = conn
                cmd.ExecuteNonQuery()
                ...
                For i As Int16 = 0 To gvqc.RowCount - 1
                    ...
                    If chkSCheck.Checked = True And dtST_Check.Text <> "" And blnSterilize = True Then
                        ...
                        cmd.CommandText = "Select count(*) from FGStock where Fid ='" & gvqc.GetRowCellValue(i, "FID") & "' and  Batch_No ='" & gvqc.GetRowCellValue(i, "Batch_NO") & "' and Type ='Inward' and Received_Qty =" & gvqc.GetRowCellValue(i, "QC_No") & " and CY ='" & strCY.Trim & "'"
                        strCount = cmd.ExecuteScalar
                        If strCount = 0 Then
                            'Finish Good Stock
                            cmd.CommandText = "Insert into FGStock values('" & gvqc.GetRowCellValue(i, "FID") & "','" & dtST_Check.Text & "','" & gvqc.GetRowCellValue(i, "Batch_NO") & "','Inward'," & gvqc.GetRowCellValue(i, "QC_No") & ",0,0," & gvqc.GetRowCellValue(i, "QC_No") & ",'" & strCY.Trim & "')"
                            cmd.ExecuteNonQuery()
                        End If
                ...
                For i As Integer = 0 To arrFID.Count - 1
                    cmd.CommandText = "Delete from FGStock where FID ='" & arrFID.Item(i).ToString & "' and Batch_No ='" & arrBatchNo.Item(i) & "' and Type = 'Inward' and Received_Qty = " & arrQC_No.Item(i)     '& " and CY ='" & strCY.Trim & "'"
                    cmd.ExecuteNonQuery()
                Next
                cmd.Transaction.Commit()
                cmd.Dispose()
    ...
    Private Sub txtVI_No_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtVI_No.Validating
        Try
            If strcheck = "Add" Then
                Dim str As String
                str = IsDuplicate("select count(FGVI_NO) from FinishGoods_QCMaster where fgvi_no ='" & txtVI_No.Text & "' and CY ='" & strCY.Trim & "'")
                If str = True Then
        ...
        Try
            If cmbMIS.Text <> "" Then
                ...
                If cmd.ExecuteScalar.ToString <> lkupFGName.Tag Then
                    ...
                    cmbMIS.Text = ""
                Else
                    strSql = "SELECT (Material_Issue_Master.FG_QTY - Sum(FinishGoods_QCDetail.Inspected_No)) AS SumOfInspected_No " _
                        & " FROM Material_Issue_Master INNER JOIN FinishGoods_QCDetail ON Material_Issue_Master.MIS_NO = FinishGoods_QCDetail.MIS_NO " _
