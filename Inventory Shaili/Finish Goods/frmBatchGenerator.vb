...
#End Region
    ...
    Private Function isLineClearanceOk() As Boolean
        ...
        Else
            ...
            If dtFGQC.Rows.Count = 0 Then
                ...
                Return isLineClear
            End If
            txtLastPackingVINo.Text = dtFGQC.Rows(0).Item("Packing_VI_NO").ToString()
    ...
    Private Function getFGQCDetails(ByVal reqId As String) As DataTable
        ...
        Dim strSql As String = "SELECT Material_Issue_Master.MIS_NO, REQMASTER.RQID,  PackingVI_Master.Packing_VI_NO," _
                    & " PackingVI_Master.PKG_VI_Date  FROM (REQMASTER INNER JOIN Material_Issue_Master ON " _
                    & " REQMASTER.RQID =  Material_Issue_Master.RQID) INNER JOIN (PackingVI_Master INNER JOIN PackingVI_Detail " _
                    & " ON  PackingVI_Master.Packing_VI_NO = PackingVI_Detail.Packing_VI_NO) ON " _
                    & " Material_Issue_Master.MIS_NO =  PackingVI_Detail.MIS_NO WHERE (((REQMASTER.RQID)='" + reqId + "') AND " _
                    & " ((REQMASTER.FID)='" + strFGID + "'))"
