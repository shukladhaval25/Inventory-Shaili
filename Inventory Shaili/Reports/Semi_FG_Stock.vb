                ...
                For i As Integer = 0 To frmpara.lstList.CheckedItems.Count - 1
                    If frmpara.strReport = "Semi_FG_Stock_Group" Then
                        ...
                        adp.SelectCommand.CommandText = "SELECT format(SemiFGStock.Date,'DD/MM/YYYY') AS TDate, GroupMaster.GroupName, SemiFGMaster.FGName, SemiFGStock.Batch_No, SemiFGStock.Type, SemiFGStock.Received_Qty as Opn_Qty, SemiFGStock.Issue_Qty, " _
                          & " UnitMaster.UnitName,SemiFGStock.Balance_Qty " _
                          & " FROM ((SemiFGMaster INNER JOIN SemiFGStock ON SemiFGMaster.SFID = SemiFGStock.SFID) INNER JOIN GroupMaster ON SemiFGMaster.GroupID = GroupMaster.GroupID) INNER JOIN UnitMaster ON SemiFGMaster.UnitID = UnitMaster.UnitID " _
                          & " WHERE (((SemiFGStock.Date) Between #" & Format(frmpara.dtpFrom.EditValue, "MM/dd/yyyy") & "#) AND #" & Format(frmpara.dtpTo.EditValue, "MM/dd/yyyy") & "#) AND ((SemiFGStock.Type)='Inword'))  and GroupMaster.GroupName ='" & strID & " Order by SemiFGMaster.FGName,SemiFGStock.Date "
                        adp.Fill(ds.Tables("Semi_FG_Stock"))
                    ...
                    Else
                        ...
                        adp.SelectCommand.CommandText = "SELECT format(SemiFGStock.Date,'DD/MM/YYYY') AS TDate, GroupMaster.GroupName, SemiFGMaster.FGName, SemiFGStock.Batch_No, SemiFGStock.Type, SemiFGStock.Received_Qty as Rec_Qty, SemiFGStock.Issue_Qty, " _
                          & " UnitMaster.UnitName,SemiFGStock.Balance_Qty " _
                          & " FROM ((SemiFGMaster INNER JOIN SemiFGStock ON SemiFGMaster.SFID = SemiFGStock.SFID) INNER JOIN GroupMaster ON SemiFGMaster.GroupID = GroupMaster.GroupID) INNER JOIN UnitMaster ON SemiFGMaster.UnitID = UnitMaster.UnitID " _
                          & " WHERE (((SemiFGStock.Date) Between #" & Format(frmpara.dtpFrom.EditValue, "MM/dd/yyyy") & "# AND #" & Format(frmpara.dtpTo.EditValue, "MM/dd/yyyy") & "#) AND ((SemiFGStock.Type)='Inward'))  and (SemiFGMaster.FGName ='" & strID & ") Order by SemiFGMaster.FGName,SemiFGStock.Date "
                        adp.Fill(ds.Tables("Semi_FG_Stock"))
