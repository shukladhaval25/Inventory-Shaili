...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtExpPeriod.Visible = False
        '
        'lblExpPeriod
        '
        Me.lblExpPeriod.Location = New System.Drawing.Point(12, 147)
        ...
        'lblgroupname
        '
        Me.lblgroupname.Location = New System.Drawing.Point(12, 97)
        ...
        Me.Name = "frmSemifgmaster"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Semi Finish Goods"
...
#End Region
    ...
    Private Sub frmfgmaster_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            If strcheck = "Add" Then
                txtid.Tag = GetMaxNo("SFid", "SemiFGMaster", "SFG", 10)
            End If
            If strcheck = "Edit" Then
                txtid.Tag = ModMain.strgridid
                cmd = New OleDb.OleDbCommand
                cmd.CommandText = "select * from SemiFGMaster where sfid='" & ModMain.strgridid & "'"
                cmd.Connection = conn
        ...
        Try
            ...
            If CheckValiDate() = True Then
                If strcheck = "Add" Then
                    ...
                    cmd = New OleDb.OleDbCommand("insert into SemiFGMaster values ( '" & txtid.Tag & "','" & Replace(txtid.Text.Trim, "'", "''") & "', '" & Replace(txtname.Text, "'", "''") & "' , '" & strgroupid.Trim & "','" & strunitid & "'," _
                ...
                ElseIf strcheck = "Edit" Then
                    cmd = New OleDb.OleDbCommand("update SemiFGMaster set sfgid= '" & Replace(txtid.Text.Trim, "'", "''") & "', fgname = '" & Replace(txtname.Text.Trim, "'", "''") & "', " _
                        ...
                        & " Min_Qty =" & txtMin_Qty.Text & ",ExpirationPeriod =" & txtExpPeriod.Text & " where sFid= '" & txtid.Tag & "'", conn)
                    cmd.ExecuteNonQuery()
                End If
                cmdsave.Enabled = False

            Else
                DevExpress.XtraEditors.XtraMessageBox.Show(Me, "Check either Semi_Finish_Good ID or Semi_Finish_Good_Name or Group_Name or Unit is not left blank", StrAppName, MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
    ...
    Private Sub cmbgrname_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbgrname.GotFocus
        Try
            ...
            cmd = New OleDb.OleDbCommand
            cmd.Connection = conn
            cmd.CommandText = "Select GroupName from GroupMaster where (GroupType ='SFG')"
            dr = cmd.ExecuteReader
            Do While dr.Read()
    ...
    Private Function CheckValiDate() As Boolean
        ...
        'NEW
        Try
            If txtid.Text = "" Or txtname.Text = "" Or cbounit.Text = "" Then
                Return False
            Else
                Return True
            End If
