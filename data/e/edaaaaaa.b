    ...
    Private Sub cmdsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdsave.Click
        Try
            ...
            If strcheck = "Add" Then
                ...
                cmd.CommandText = "insert into RM_Opening_Stock values (" & intID & ",'" & strRID & "','" & strUID & "','" & Replace(txtRMVINO.Text, "'", "''") & "'," & txtQty.Text & ",'" & dtpdate.Text & "','" & strCY & "')"
                cmd.ExecuteNonQuery()

                cmd.CommandText = "Insert into RMStock values ('" & strRID & "','" & dtpdate.Text & "','" & Replace(txtRMVINO.Text, "'", "''") & "','Opening'," & txtQty.Text & ",0,0," & txtQty.Text & ",'" & strCY & "')"
                cmd.ExecuteNonQuery()
