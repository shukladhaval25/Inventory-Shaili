...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'txtReqID
        '
        Me.txtReqID.EditValue = Global.Inventory_Shaili.rptSupplier.
        ...
        Me.lblUOM.Location = New System.Drawing.Point(424, 64)
        ...
        'txtfQty
        '
        Me.txtfQty.EditValue = Global.Inventory_Shaili.rptSupplier.
        Me.txtfQty.Location = New System.Drawing.Point(392, 61)
        ...
        'cboUOM
        '
        Me.cboUOM.EditValue = Global.Inventory_Shaili.rptSupplier.
        ...
        'txtqty
        '
        Me.txtqty.EditValue = Global.Inventory_Shaili.rptSupplier.
        ...
        'lkupItemName
        '
        Me.lkupItemName.EditValue = Global.Inventory_Shaili.rptSupplier.
        ...
        Me.lkupItemName.Properties.NullText = Global.Inventory_Shaili.rptSupplier.
        ...
        '
        '
        Me.gdbatch.EmbeddedNavigator.Name = Global.Inventory_Shaili.rptSupplier.
        ...
        'lkupFG
        '
        Me.lkupFG.EditValue = Global.Inventory_Shaili.rptSupplier.
        ...
        Me.lkupFG.Properties.NullText = Global.Inventory_Shaili.rptSupplier.
    ...
    Private Sub frmBatchGenerator_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            If strcheck = "Edit" Then
                ...
                cmd.CommandText = "SELECT REQMASTER.RQID , REQMASTER.REQID, FGMaster.FGName, UnitMaster.UnitName, REQMASTER.QTY,REQMASTER.TYPE,REQMASTER.FID,REQMASTER.REQDATE " _
                ...
                Dim adp As New OleDb.OleDbDataAdapter("SELECT  REQDETAIL.RID AS ITEMID, RMItemMaster.RMItemName AS [ITEM NAME], REQDETAIL.UID AS UNITID, " _
                    & " UnitMaster.UnitName AS UNIT, REQDETAIL.QTY ,REQDETAIL.RQID AS RQID" _
        ...
        Try
            If strcheck = "Add" Then
                If ISVALIDATE() = True Then
                    ...
                    cmd.CommandText = "insert into REQMASTER (rqid,rEQid,reqdate,fid,type,qty,cy)" & _
    ...
    Private Sub FillGrid()
        Try
            ...
            Dim adp As New OleDb.OleDbDataAdapter("SELECT Batchdetail.RID AS ITEMID, RMItemMaster.RMItemName AS [ITEM NAME]," _
                      & " Batchdetail.UnitID AS UNITID, UnitMaster.UnitName AS UNIT, ([Batchdetail]![Qty] * " & Val(txtfQty.Text) & ")/[BatchMaster]![Qty] AS Qty " _
