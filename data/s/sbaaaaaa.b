    ...
    Private Sub cmdsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdsave.Click
        Try
            If strcheck = "Add" Then
                cmd = New OleDb.OleDbCommand
                cmd.Connection = conn
                cmd.CommandText = "insert into FinishGoods_QCMaster values ('" & txtSrNo.Text.Trim & "','" & Replace(txtVI_No.Text, "''", "'") & "','" & dtinspection.Text & "'," & chkSCheck.Checked & "," & IIf(dtST_Check.Text = "", "Null", "'" & dtST_Check.Text & "'") & ",'" & strCY.Trim & "','" & Replace(txtPackingVINo.Text, "''", "'") & "','" & dtPackingVI.Text & "')"
