...
Public Class frmSemiFG_Mat_Issue
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'txtFgQty
        '
        Me.txtFgQty.Location = New System.Drawing.Point(488, 56)
        ...
        'Label8
        '
        Me.Label8.Location = New System.Drawing.Point(456, 58)
        ...
        Me.Label3.Text = "Semi Finish Good:"
        '
        'txtFG
        '
        Me.txtFG.Location = New System.Drawing.Point(288, 56)
        Me.txtFG.Name = "txtFG"
        ...
        Me.Name = "frmSemiFG_Mat_Issue"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Semi Finish Good Material Issue"
...
#End Region
    ...
    Private Sub cboReqNo_GotFocus(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'Try
        '    'FillCombox("SEMI_FG_REQMASTER", "rqid", cboReqNo)
        '    cboReqNo.Properties.Items.Clear()
        '    Dim dr As OleDb.OleDbDataReader
        '    cmd = New OleDb.OleDbCommand
        '    cmd.Connection = conn

        '    cmd.CommandText = "Select count(*) from SEMI_Material_Issue_Master "
        '    If cmd.ExecuteScalar > 0 Then
        '        cmd.CommandText = "SELECT SEMI_FG_REQMASTER.RQID " _
        '            & " FROM SEMI_FG_REQMASTER INNER JOIN SEMI_Material_Issue_Master ON SEMI_FG_REQMASTER.RQID <> SEMI_Material_Issue_Master.RQID " _
        '            & " GROUP BY SEMI_FG_REQMASTER.RQID ORDER BY SEMI_FG_REQMASTER.RQID "
        '    Else
        '        cmd.CommandText = "SELECT SEMI_FG_REQMASTER.RQID FROM SEMI_FG_REQMASTER ORDER BY REQID "
        '    End If
    ...
    Private Sub frmMat_Issue_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If strcheck = "Add" Then
                ...
                cmd.CommandText = "Select count(*) from SEMI_Material_Issue_Master "
                If cmd.ExecuteScalar > 0 Then
                    strSql = "SELECT  SEMI_FG_REQMASTER.REQID, SEMI_FG_REQMASTER.RQID " _
                        & " FROM SEMI_FG_REQMASTER INNER JOIN SEMI_Material_Issue_Master ON SEMI_FG_REQMASTER.RQID <> SEMI_Material_Issue_Master.RQID where SEMI_FG_REQMASTER.CY ='" & strCY.Trim & "'" _
                        & " GROUP BY SEMI_FG_REQMASTER.RQID,SEMI_FG_REQMASTER.REQID ORDER BY SEMI_FG_REQMASTER.RQID "

                    'check code for CY related Join Query
                    'SELECT SEMI_FG_REQMASTER.REQID, SEMI_FG_REQMASTER.RQID
                    'FROM SEMI_FG_REQMASTER INNER JOIN SEMI_Material_Issue_Master ON (SEMI_FG_REQMASTER.CY = SEMI_Material_Issue_Master.CY) AND  (SEMI_FG_REQMASTER.RQID <> SEMI_Material_Issue_Master.RQID)
                    'GROUP BY SEMI_FG_REQMASTER.REQID, SEMI_FG_REQMASTER.RQID
                    'ORDER BY SEMI_FG_REQMASTER.RQID;

                Else
                    strSql = "SELECT SEMI_FG_REQMASTER.REQID,SEMI_FG_REQMASTER.RQID FROM SEMI_FG_REQMASTER ORDER BY REQID"
                End If
                FillLookup(strSql, "SEMI_FG_REQMASTER", "Requisition No", "Req ID", lkupReqNo)
                cmd.Dispose()
            ...
            If strcheck = "Edit" Then
                ...
                cmd = New OleDb.OleDbCommand
                cmd.Connection = conn
                cmd.CommandText = "SELECT SEMI_Material_Issue_Master.*, SemiFGMaster.FGName " _
                    & " FROM SEMI_Material_Issue_Master INNER JOIN SemiFGMaster ON " _
                    & " SEMI_Material_Issue_Master.SFGID = SemiFGMaster.SFID where SEMI_Material_Issue_Master.mis_no = '" & ModMain.strgridid & "'" ' and SEMI_Material_Issue_Master.CY ='" & strCY.Trim & "'"
                dr = cmd.ExecuteReader
                dr.Read()
                bind_data()
                dr.Close()
    ...
    Private Sub bind_data()
        ...
        Try
            ...
            Dim adp As New OleDb.OleDbDataAdapter("SELECT SEMI_Material_Issue_Detail.RID, RMItemMaster.RMItemName as [Item Name] , SEMI_Material_Issue_Detail.RMVI_NO, UnitMaster.UnitName as Unit, " _
                 & " SEMI_FG_REQDETAIL.QTY as [Req Qty]," _
                 & " SEMI_Material_Issue_Detail.Issued_Qty as [Issued Qty], SEMI_Material_Issue_Detail.MIS_NO " _
                 & " FROM (((SEMI_Material_Issue_Master INNER JOIN SEMI_Material_Issue_Detail ON SEMI_Material_Issue_Master.MIS_NO = SEMI_Material_Issue_Detail.MIS_NO) INNER JOIN SEMI_FG_REQDETAIL ON (SEMI_Material_Issue_Master.RQID = SEMI_FG_REQDETAIL.RQID) AND (SEMI_Material_Issue_Detail.RID = SEMI_FG_REQDETAIL.RID)) " _
                 & " INNER JOIN UnitMaster ON SEMI_FG_REQDETAIL.UID = UnitMaster.UnitID) INNER JOIN RMItemMaster ON (UnitMaster.UnitID = RMItemMaster.UnitId) AND (SEMI_Material_Issue_Detail.RID = RMItemMaster.Rid)" _
                 & " WHERE (((SEMI_Material_Issue_Detail.MIS_NO)='" & ModMain.strgridid.Trim & "')) ", conn) 'and SEMI_Material_Issue_Master.CY ='" & strCY.Trim & "'
    ...
    Private Sub cmdsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdsave.Click
        ...
        Try
            Dim str As String
            If strcheck = "Add" Then
                str = "select count(MIS_NO) from SEMI_Material_Issue_Master where mis_No= '" & txtMatIssNo.Text & "' and cy ='" & strCY.Trim & "'"
                ...
                cmd.CommandText = "insert into SEMI_Material_Issue_Master values ('" & Replace(txtMatIssNo.Text, "''", "'") & "','" & dtpMatIssDate.Text & "','" & lkupReqNo.Tag.Trim & "','" & txtFG.Tag & "'," & txtFgQty.Text & "," & chkVIReq.Checked & ",'" & strCY.Trim & "')"
                cmd.ExecuteNonQuery()

                For i As Int16 = 0 To gvMatIssue.RowCount - 1
                    cmd.CommandText = "insert into SEMI_Material_Issue_Detail values('" & Replace(txtMatIssNo.Text, "''", "'") & "','" & gvMatIssue.GetRowCellValue(i, "RID") & "','" & gvMatIssue.GetRowCellValue(i, "RMVI_NO") & "'," & gvMatIssue.GetRowCellValue(i, "Issued Qty") & ",'" & strCY.Trim & "')"
                    cmd.ExecuteNonQuery()
                    ...
                    'Else
                    'cmd.CommandText = "update SemiFGStock set Issue_Qty = (Issue_Qty + " & gvMatIssue.GetRowCellValue(i, "Issued Qty") & "), Balance_Qty = (Balance_Qty - " & gvMatIssue.GetRowCellValue(i, "Issued Qty") & ") WHERE SFGVI_No='" & gvMatIssue.GetRowCellValue(i, "RMVI_NO") & "' AND SFID ='" & gvMatIssue.GetRowCellValue(i, "RID") & "'" ' and CY ='" & strCY.Trim & "'"
                    'End If
                    cmd.ExecuteNonQuery()
                Next
            ...
            ElseIf strcheck = "Edit" Then
                ...
                cmd.Connection = conn
                cmd.Transaction = conn.BeginTransaction
                cmd.CommandText = "update SEMI_Material_Issue_Master set mis_no = '" & txtMatIssNo.Text.Trim & "', mis_date = '" & dtpMatIssDate.Text & "',VI_Req =" & chkVIReq.Checked & " where mis_No = '" & ModMain.strgridid & "'" ' and CY ='" & strCY.Trim & "'"
                cmd.ExecuteNonQuery()

                cmd.CommandText = "delete from SEMI_Material_Issue_Detail where mis_No = '" & ModMain.strgridid & "' " ' and CY ='" & strCY.Trim & "'"
                cmd.ExecuteNonQuery()
                For i As Int16 = 0 To gvMatIssue.RowCount - 1
                    cmd.CommandText = "insert into SEMI_Material_Issue_Detail values('" & Replace(txtMatIssNo.Text, "''", "'") & "','" & gvMatIssue.GetRowCellValue(i, "RID") & "','" & gvMatIssue.GetRowCellValue(i, "RMVI_NO") & "'," & gvMatIssue.GetRowCellValue(i, "Issued Qty") & ",'" & strCY.Trim & "')"
                    cmd.ExecuteNonQuery()
    ...
    '        Dim dr As OleDb.OleDbDataReader
    '        cmd.Connection = conn
    '        cmd.CommandText = "SELECT FGMaster.FID, FGMaster.FGName, SEMI_FG_REQMASTER.RQID,SEMI_FG_REQMASTER.QTY " _
    '            & " FROM SEMI_FG_REQMASTER INNER JOIN FGMaster ON SEMI_FG_REQMASTER.FID = FGMaster.FID " _
    '            & " WHERE (((SEMI_FG_REQMASTER.RQID)='" & cboReqNo.Text.Trim & "'));"
    '        dr = cmd.ExecuteReader
    '        Do While dr.Read
    '            blnCheck = True
    ...
    '            Dim strSql As String
    '            If strcheck = "Add" Then
    '                strSql = "SELECT RMItemMaster.RID as RID, RMItemMaster.RMItemName as [Item Name], SEMI_FG_REQDETAIL.UID as UID, UnitMaster.UnitName as Unit, SEMI_FG_REQDETAIL.QTY as [Req Qty]" _
    '                    & " FROM (RMItemMaster INNER JOIN SEMI_FG_REQDETAIL ON RMItemMaster.Rid = SEMI_FG_REQDETAIL.RID) INNER JOIN UnitMaster ON SEMI_FG_REQDETAIL.UID = UnitMaster.UnitID where " _
    '                    & " SEMI_FG_REQDETAIL.RQID ='" & cboReqNo.Text.Trim & "'"
    '            ElseIf strcheck = "Edit" Then
    '                strSql = "SELECT SEMI_Material_Issue_Detail.RID, RMItemMaster.RMItemName as [Item Name] , SEMI_Material_Issue_Detail.RMVI_NO, UnitMaster.UnitName as Unit, " _
    '                     & " SEMI_FG_REQDETAIL.QTY as [Req Qty]," _
    '                     & " SEMI_Material_Issue_Detail.Issued_Qty as [Issued Qty], SEMI_Material_Issue_Detail.MIS_NO " _
    '                     & " FROM (((SEMI_Material_Issue_Master INNER JOIN SEMI_Material_Issue_Detail ON SEMI_Material_Issue_Master.MIS_NO = SEMI_Material_Issue_Detail.MIS_NO) INNER JOIN SEMI_FG_REQDETAIL ON (SEMI_Material_Issue_Master.RQID = SEMI_FG_REQDETAIL.RQID) AND (SEMI_Material_Issue_Detail.RID = SEMI_FG_REQDETAIL.RID)) " _
    '                     & " INNER JOIN UnitMaster ON SEMI_FG_REQDETAIL.UID = UnitMaster.UnitID) INNER JOIN RMItemMaster ON (UnitMaster.UnitID = RMItemMaster.UnitId) AND (SEMI_Material_Issue_Detail.RID = RMItemMaster.Rid)" _
    '                     & " WHERE (((SEMI_Material_Issue_Detail.MIS_NO)='" & txtMatIssNo.Text.Trim & "'))"
        ...
        Try
            If strcheck = "Add" Then
                If txtMatIssNo.Text.Trim <> "" Then
                    ...
                    strOrderNo = IsDuplicate("Select count(MIS_NO) from SEMI_Material_Issue_Master where MIS_NO = '" & txtMatIssNo.Text.Trim & "' and CY ='" & strCY.Trim & "'")
    ...
    Private Sub cmdReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdReport.Click
        Try
            ...
            myPara.ShowCMIS(ModMain.strgridid.Trim & "'")
            myPara.Close()
        Catch ex As Exception
            If show_error Then
                MsgBox(ex.ToString)
    ...
    Private Sub lkupReqNo_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles lkupReqNo.TextChanged
        Try
            If lkupReqNo.Tag <> "" Then
                ...
                Dim dr As OleDb.OleDbDataReader
                cmd.Connection = conn
                cmd.CommandText = "SELECT SemiFGMaster.SFID, semiFGMaster.FGName, SEMI_FG_REQMASTER.RQID,SEMI_FG_REQMASTER.QTY " _
                    & " FROM SEMI_FG_REQMASTER INNER JOIN SemiFGMaster ON SEMI_FG_REQMASTER.SFID = SemiFGMaster.SFID " _
                    & " WHERE (((SEMI_FG_REQMASTER.RQID)='" & lkupReqNo.Tag.Trim & "')) and SEMI_FG_REQMASTER.CY ='" & strCY.Trim & "';"
                dr = cmd.ExecuteReader
                Do While dr.Read
                    blnCheck = True
                    txtFG.Text = dr.Item("FGName").ToString.Trim
                    txtFG.Tag = dr.Item("SFID").ToString.Trim
                    txtFgQty.Text = dr.Item("QTY").ToString.Trim
                Loop
                dr.Close()
                cmd.Dispose()
                ...
                Else
                    ...
                    If strcheck = "Add" Then
                        strSql = "SELECT RMItemMaster.RID as RID, RMItemMaster.RMItemName as [Item Name], SEMI_FG_REQDETAIL.UID as UID, UnitMaster.UnitName as Unit, SEMI_FG_REQDETAIL.QTY as [Req Qty]," _
                            & " 'RM' as ProductType FROM (RMItemMaster INNER JOIN SEMI_FG_REQDETAIL ON RMItemMaster.Rid = SEMI_FG_REQDETAIL.RID) INNER JOIN UnitMaster ON SEMI_FG_REQDETAIL.UID = UnitMaster.UnitID where " _
                            & " SEMI_FG_REQDETAIL.RQID ='" & lkupReqNo.Tag.Trim & "' AND SEMI_FG_REQDETAIL.CY ='" & strCY.Trim & "'"
                    ElseIf strcheck = "Edit" Then
                        strSql = "SELECT SEMI_Material_Issue_Detail.RID, RMItemMaster.RMItemName as [Item Name] , SEMI_Material_Issue_Detail.RMVI_NO, UnitMaster.UnitName as Unit, " _
                             & " SEMI_FG_REQDETAIL.QTY as [Req Qty]," _
                             & " SEMI_Material_Issue_Detail.Issued_Qty as [Issued Qty], SEMI_Material_Issue_Detail.MIS_NO " _
                             & " FROM (((SEMI_Material_Issue_Master INNER JOIN SEMI_Material_Issue_Detail ON SEMI_Material_Issue_Master.MIS_NO = SEMI_Material_Issue_Detail.MIS_NO) INNER JOIN SEMI_FG_REQDETAIL ON (SEMI_Material_Issue_Master.RQID = SEMI_FG_REQDETAIL.RQID) AND (SEMI_Material_Issue_Detail.RID = SEMI_FG_REQDETAIL.RID)) " _
                             & " INNER JOIN UnitMaster ON SEMI_FG_REQDETAIL.UID = UnitMaster.UnitID) INNER JOIN RMItemMaster ON (UnitMaster.UnitID = RMItemMaster.UnitId) AND (SEMI_Material_Issue_Detail.RID = RMItemMaster.Rid)" _
                             & " WHERE (((SEMI_Material_Issue_Detail.MIS_NO)='" & txtMatIssNo.Text.Trim & "')) AND SEMI_Material_Issue_Detail.CY ='" & strCY.Trim & "'"
                    End If
    ...
    Private Function fillDataSetWithSemiFinishGood() As DataTable
        ...
        If (strcheck = "Add") Then
            Dim strSql As String
            strSql = "SELECT SemiFGMaster.SFID as RID, SemiFGMaster.FGName as [Item Name], SEMI_FG_REQDETAIL.UID as UID, UnitMaster.UnitName as Unit, SEMI_FG_REQDETAIL.QTY as [Req Qty]" _
                & " FROM (SemiFGMaster INNER JOIN SEMI_FG_REQDETAIL ON SemiFGMaster.SFid = SEMI_FG_REQDETAIL.RID) INNER JOIN UnitMaster ON SEMI_FG_REQDETAIL.UID = UnitMaster.UnitID where " _
                & " SEMI_FG_REQDETAIL.RQID ='" & lkupReqNo.Tag.Trim & "' AND SEMI_FG_REQDETAIL.CY ='" & strCY.Trim & "'"
            Dim adpt As New OleDb.OleDbDataAdapter(strSql, conn)
            adpt.Fill(dtSemiFG)
